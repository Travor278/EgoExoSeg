...
def main():
 ...
 'annotation_sha256':spec['annotation_sha256'],'scope':'Exo2Ego full benchmark using corrected Visual e19/Fusion e20; primary geometry-consensus gate; other methods exploratory' if args.stage=='full' else 'runtime smoke test; do not infer scientific gains from it','same_candidate_bank':True,'parameter_fitting':False}
 ...
 lines+=['','No model or threshold changes. All methods use the same freshly frozen V2-SAM candidate bank. Bootstrap resamples takes while preserving frame weighting for unequal take lengths. No fitting or threshold selection on these test outcomes. This full Exo2Ego benchmark was evaluated previously using author weights; report this as a frozen corrected-weight comparison, not an entirely unseen cohort.']
