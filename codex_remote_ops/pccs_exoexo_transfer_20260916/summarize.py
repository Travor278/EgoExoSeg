...
def main():
 ...
 'annotation_sha256':spec['annotation_sha256'],'scope':'Exo2Exo full benchmark, using frozen Exo2Ego experts and gate; zero-shot transfer' if args.stage=='full' else 'runtime smoke test; do not infer scientific gains from it','same_candidate_bank':True,'parameter_fitting':False}
