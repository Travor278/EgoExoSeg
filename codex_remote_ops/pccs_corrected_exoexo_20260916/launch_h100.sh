set -euo pipefail
R=/inspire/hdd/project/luojianlan/zhubingwen-253108120125/codex_remote_ops/pccs_corrected_exoexo_20260916
P=/inspire/hdd/project/luojianlan/zhubingwen-253108120125/codex_remote_ops/context_pccs_20260914
exec 9>"$R/.experiment.lock"
flock -n 9 || { echo 'CORRECTED_EXOEXO_ALREADY_RUNNING'; exit 2; }
