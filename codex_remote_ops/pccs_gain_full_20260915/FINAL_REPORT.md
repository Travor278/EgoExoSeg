...
**双seed全量复验已完成并核验通过。** 1.5×主方案两轮分别+2.4599/+2.4984点，2×对照分别+2.5142/+2.5334点，四项95% take区间下界为正。两轮均完整46515对/109253对象/295takes；seed2于2026-09-19 06:52:22结束，节点0。该重复性针对相同场景集合的候选随机性，不能把两个seed作为新增独立场景证据；当前同候选O-MaMa共同候选复验仍待完成，见§17。
...
同候选全量O-MaMa结果待完成；提交、pilot或重建完成均不等于最终对照完成。
